...
function ProductSalesList() {
  ...
  useEffect(() => {
    ...
    const mockSales: SalesItem[] = [
      { id: 11, orderNo: '250902101500001', buyerId: 1001, productId: 11, productName: '삼성 갤럭시 북4 Pro', quantity: 1, soldAt: '2025-09-02T10:15:00', totalPrice: 1850000 },
      { id: 12, orderNo: '250902101500001', buyerId: 1001, productId: 12, productName: '삼성 갤럭시 S24 Ultra', quantity: 1, soldAt: '2025-09-02T10:15:00', totalPrice: 1550000 },
      { id: 13, orderNo: '250902101500001', buyerId: 1001, productId: 13, productName: '삼성 커스텀 기계식 키보드', quantity: 1, soldAt: '2025-09-02T10:15:00', totalPrice: 150000 },
      { id: 1, orderNo: '250902101500001', buyerId: 1001, productId: 1, productName: '[Apple] 맥북 프로 14인치 M3 Pro 실버', quantity: 1, soldAt: '2025-09-02T10:15:00', totalPrice: 2990000 },
      { id: 2, orderNo: '250902101500001', buyerId: 1001, productId: 3, productName: '[Logitech] MX Keys Mini 무선 기계식 키보드', quantity: 2, soldAt: '2025-09-02T10:15:00', totalPrice: 178000 },
      { id: 3, orderNo: '250905143000002', buyerId: 1002, productId: 2, productName: '[Apple] 아이폰 15 Pro 256GB 내추럴 티타늄', quantity: 1, soldAt: '2025-09-05T14:30:00', totalPrice: 1550000 },
      { id: 4, orderNo: '250910164500003', buyerId: 1003, productId: 8, productName: '[Pearson] 클린 코드: 애자일 소프트웨어 장인 정신', quantity: 1, soldAt: '2025-09-10T16:45:00', totalPrice: 33000 },
      { id: 5, orderNo: '250910164500003', buyerId: 1003, productId: 9, productName: '[OReilly] 자바 ORM 표준 JPA 프로그래밍 가이드', quantity: 1, soldAt: '2025-09-10T16:45:00', totalPrice: 38000 },
      { id: 6, orderNo: '250914130000005', buyerId: 1004, productId: 6, productName: '[CJ] 서귀포 프리미엄 고당도 제주 감귤 2kg', quantity: 3, soldAt: '2025-09-14T13:00:00', totalPrice: 45000 },
      { id: 7, orderNo: '250916083000006', buyerId: 1001, productId: 3, productName: '[Logitech] MX Keys Mini 무선 기계식 키보드', quantity: 1, soldAt: '2025-09-16T08:30:00', totalPrice: 89000 },
      { id: 8, orderNo: '250916083000006', buyerId: 1001, productId: 8, productName: '[Pearson] 클린 코드: 애자일 소프트웨어 장인 정신', quantity: 1, soldAt: '2025-09-16T08:30:00', totalPrice: 33000 },
      { id: 9, orderNo: '250924153000010', buyerId: 1005, productId: 4, productName: '[Uniqlo] 프리미엄 리넨 셔츠 (긴팔) 화이트 L', quantity: 2, soldAt: '2025-09-24T15:30:00', totalPrice: 98000 },
      { id: 10, orderNo: '251003133000015', buyerId: 1002, productId: 2, productName: '[Apple] 아이폰 15 Pro 256GB 내추럴 티타늄', quantity: 1, soldAt: '2025-10-03T13:30:00', totalPrice: 1550000 }
    ];
    setSales(mockSales);
