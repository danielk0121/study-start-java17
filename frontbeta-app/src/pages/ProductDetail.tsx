    ...
    const mockProducts: Product[] = [
      {
        ...
        thumbnailUrl1: `${import.meta.env.BASE_URL}assets/sample/macbook.jpg`,
        thumbnailUrl2: `${import.meta.env.BASE_URL}assets/sample/macbook.jpg`,
        thumbnailUrl3: `${import.meta.env.BASE_URL}assets/sample/macbook.jpg`,
        detailUrl1: `${import.meta.env.BASE_URL}assets/sample/macbook.jpg`,
        detailUrl2: `${import.meta.env.BASE_URL}assets/sample/macbook.jpg`,
        detailUrl3: `${import.meta.env.BASE_URL}assets/sample/macbook.jpg`,
        salesCount: 15
      },
      { id: 2, name: '[Apple] 아이폰 15 Pro 256GB 내추럴 티타늄', price: 1550000, stock: 25, category: '전자기기', sellerId: 1, sellerName: '애플공식몰', brandName: '애플', brandThumbnailUrl: `${import.meta.env.BASE_URL}assets/sample/brand-apple.png`, 
        thumbnailUrl1: `${import.meta.env.BASE_URL}assets/sample/iphone.jpg`, 
        thumbnailUrl2: `${import.meta.env.BASE_URL}assets/sample/iphone.jpg`,
        salesCount: 42 },
      { id: 3, name: '[Logitech] MX Keys Mini 무선 기계식 키보드', price: 89000, stock: 50, category: '전자기기', sellerId: 2, sellerName: '테크마트', brandName: '로지텍', brandThumbnailUrl: `${import.meta.env.BASE_URL}assets/sample/brand-logitech.png`, 
        thumbnailUrl1: `${import.meta.env.BASE_URL}assets/sample/keyboard.jpg`,
        thumbnailUrl2: `${import.meta.env.BASE_URL}assets/sample/keyboard.jpg`,
        salesCount: 120 }
    ];
