...
function ManagerRegister() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Seller Register attempt:', formData);
    alert('판매자 회원가입 시도 (API 연동 예정)');
  };

  return (
    <div style={{ maxWidth: '400px', margin: '0 auto', padding: '2rem', border: '1px solid #d00' }}>
      <h1 style={{ color: '#d00' }}>판매자 가입</h1>
      <p style={{ fontSize: '0.9rem', color: '#666' }}>판매자 권한 신청을 위해 정보를 입력하세요.</p>
